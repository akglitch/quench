      ...
      {productData.map((product, index) => (
        <div key={index} className="relative m-4 flex w-full max-w-sm flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
          ...
          <div className="mt-4 px-5 pb-5">
            ...
            <a href="#" className="flex items-center bg-gray-700 justify-center rounded-md px-4 py-2 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
